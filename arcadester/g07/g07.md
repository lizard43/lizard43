...
# Deflection Yoke Interconnect Plug (T502 Area)
...
![G07 Yoke Plug Physical Connector](./images/G07-yoke-plug.png)

![G07 Yoke Plug Schematic Location](./images/G07-yoke-plug-schematic.png)

---

## 2. Connector Mechanical & Material Specifications
...
### Industrial Sourcing Part Numbers
...
## 3. Pin-Out Configuration & Deflection Mapping
...
## 4. Deep-Dive Bench & Diagnostic Notes
...
#### 1. Thermal Degradation & Melted Shells
...
![G07 Degauss Connector](./images/G07-degauss.png)

![G07 Degauss Schematic Location](./images/G07-degauss-schematic.png)

---

## 2. Connector Mechanical & Component Specifications
...
### Material Sourcing & Retrofitting Part Numbers
...
## 3. Pin-Out Configuration & Circuit Flow
...
| :--- | :--- | :--- | :--- | :--- |
| **Pin 1** | **I1** | Orange / Black | **Degauss Coil Loop In** | Raw Isolated AC Mains input side (~120VAC line loop) |
| **Pin 2** | **I2** | Orange / Black | **Degauss Coil Loop Out** | Return leg feeding into the Thermistor/Posistor circuit |

---

## 4. Deep-Dive Circuit Theory & Operations ("The Meat")
...
## 5. Critical Bench Notes & Troubleshooting

### The Infamous "Black Wire Ground" Blunder
